...
$soli = $_POST['inputsoli']s
$date = $_POST['inputdate']
 ?>
 <!DOCTYPE html>
 <html>
 <head>
  <title>VALIDAR la cancelación de la cita médica</title>
<meta charset="utf-8">
 ...
 <b><span class="validar_title_min" style="font-family: times new roman; font-size: 15px; color: blue">EL TIPO DE SOLICITUD ES:</span></b><b style="font-family: times new roman; font-size: 15px; color: #18453a">Cancelar cita</b><br>s
 ...
 <br>
 <br>
<a href="../../pag_principal/pagina_principal_paciente.html"><input type="button"class="btn btn-success" value="Listo"/>
	<a href="../../../index.html"><input type="button" class="btn btn-info" value="Volver al inicio"/> </a>
	<br/>
	<br/>
	<a href="../../control/cancelar/canc_cita.html"><input type="button" class="btn btn-danger" value="volver al formulario"/> </a>
	</div>
	<div id="div_footer">		
			<img src="../../../css/imagenes/fondo_cut.png"/>			
	</div>
