...
$mensaje = $consultas->borrarPaciente($idPaciente);
 ?>
...
<div id="header">
  ...
  <hr>
 <label class="informaciónderegistro"><b>*Está seguro de eliminar al paciente<br> identificado con el numero de identificación: <input required type="text" id="idShow" name="idShow" class="form-control" value="<?php echo $idPaciente;?>" disabled> <input name="id"  type="hidden" value="<?php echo $idPaciente;?>"></b></label>  
    <br>
