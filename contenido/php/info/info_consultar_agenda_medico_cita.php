...
$date = $_POST['inputdate']
 ...
 <html>
 <head>
  <title>VALIDAR La consulta de agenda del medico</title>
<meta charset="utf-8">
 ...
 <b><span class="validar_title_min" style="font-family: times new roman; font-size: 15px; color: blue">EL TIPO DE SOLICITUD ES:</span></b><b style="font-family: times new roman; font-size: 15px; color: #18453a">Consultar agenda médica</b><br>
...
<a href="../../pag_principal/pagina_principal_medico.html"><input type="button"class="btn btn-success" value="Listo"/>
	...
	<br/>
	<br/>
	<a href="../../control/consulta/consultar_agenda_medico.html"><input type="button" class="btn btn-danger" value="volver al formulario"/> </a>
	</div>
	<div id="div_footer">		
			<img src="../../../css/imagenes/fondo_cut.png"/>			
	</div>
