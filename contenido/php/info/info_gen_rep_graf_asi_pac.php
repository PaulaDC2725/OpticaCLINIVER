...
$date = $_POST['inputdate']
 ...
 <html>
 <head>
  <title>VALIDAR El reporte grafico de la asistencia de los pacientes</title>
<meta charset="utf-8">
 ...
 <b><span class="validar_title_min" style="font-family: times new roman; font-size: 15px; color: blue">EL TIPO DE SOLICITUD ES:</span></b><b style="font-family: times new roman; font-size: 15px; color: #18453a">reporte gráfico de la asistencia</b><br>
 ...
 <b><span class="validar_title_min"style="font-family: times new roman; font-size: 15px; color: blue">LA FECHA  ES: </span></b> <strong><?php echo($date); ?></strong> <br>
 ...
 <br>
 <br>
<a href="../../pag_principal/pagina_principal_secretaria.html"><input type="button"class="btn btn-success" value="Listo"/>
	<a href="../../../index.html"><input type="button" class="btn btn-info" value="Volver al inicio"/> </a>
	<br/>
	<br/>
	<a href="../../reportes/gen_rep_graf_asi_pac.html"><input type="button" class="btn btn-danger" value="volver al formulario"/> </a>
	</div>
	<div id="div_footer">		
			<img src="../../../css/imagenes/fondo_cut.png"/>			
	</div>
