...
$usu = $_POST['usu'];
 ...
 <html>
 <head>
  <title>VALIDAR El registro de los resultados de laboratorio</title>
<meta charset="utf-8">
 ...
 <b><span class="validar_title_min" style="font-family: times new roman; font-size: 15px; color: blue">EL TIPO DE SOLICITUD ES:</span></b><b style="font-family: times new roman; font-size: 15px; color: #18453a">Registro de resultados</b><br>
...
<a href="../../pag_principal/pagina_principal_secretaria.html"><input type="button"class="btn btn-success" value="Listo"/>
	...
	<br/>
	<br/>
	<a href="../../registrar/reg_res_lab.html"><input type="button" class="btn btn-danger" value="volver al formulario"/> </a>
	</div>
	<div id="div_footer">		
			<img src="../../../css/imagenes/fondo_cut.png"/>			
	</div>
