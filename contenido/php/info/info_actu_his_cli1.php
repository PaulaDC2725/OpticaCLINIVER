...
$usu = $_POST['usu'];
 ...
 <html>
 <head>
  <title>VALIDAR Consulta de historia clínica(MEDICO)</title>
<meta charset="utf-8">
 ...
 <b><span class="validar_title_min" style="font-family: times new roman; font-size: 15px; color: blue">EL TIPO DE SOLICITUD ES:</span></b><b style="font-family: times new roman; font-size: 15px; color: #18453a">Actualización Historia Clinica</b><br>
...
<a href="../../pag_principal/pagina_principal_medico.html"><input type="button"class="btn btn-success" value="Listo"/>
	...
	<br/>
	<br/>
	<a href="../../control/actualizar/actu_his_cli.html"><input type="button" class="btn btn-danger" value="volver al formulario"/> </a>
	</div>
	<div id="div_footer">		
			<img src="../../../css/imagenes/fondo_cut.png"/>			
	</div>
