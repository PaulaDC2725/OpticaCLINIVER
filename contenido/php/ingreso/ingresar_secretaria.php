...
if($usuario=='ElsaAlayonsec' && $contrasenia=='cliniverOptica26'){
	header('location: ../../pag_principal/pagina_principal_secretaria.html');
}
else{
...
<br>
<div id="footer">   
  <a href="../../../contenido/login/login_cliniver_secretaria.html">
