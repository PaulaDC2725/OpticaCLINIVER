...
$filas = $consultasUsuario->validarLoginUsuario($usuario,$contrasenia,"Médico",$estadoU);
$resultado=0;
...
if ($resultado=="1"){
	header('location: ../../pag_principal/pagina_principal_medico.html');
}else{
...
<br>
<div id="footer">   
  <a href="../../login/login_cliniver_medico.html">
