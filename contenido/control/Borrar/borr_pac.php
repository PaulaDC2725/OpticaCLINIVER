...
<html>
<head>
  <title>BORRAR USUARIO PACIENTE</title>
  <meta charset="utf-8">
  ...
  <script src="../../../js/scriptinfoBorr1.js"></script>
</head> 
<body>
  <div id="div_header">    
...
<div id="header">
  ...
  <h2 class="login__title">VALIDAR INFORMACIÓN DE LA ELIMINACIÓN DEL PACIENTE</h2>
   <form action="../../php/info/info_borr_pac.php" method="post" id="form"> 
  <div class="form-row">
        <div class="form-group col-md-6 col-lg-6 col-sm-6">
      <label for="id">¿Es este el número de documento del paciente que desea eliminar?</label>
  ...
  <div class="form-row">
    <div class="form-group col-md-6 col-lg-6 col-sm-6">
      <label for="nom">¿Este es el nombre del paciente que desea eliminar?</label>
      <input required type="text" id="nomShow" name="nomShow" placeholder="ingresa tu nombre" class="form-control" value="<?php echo $nombrePaciente;?>" disabled>
        <br> 
        <input name="nom" id="nom" type="hidden" value="<?php echo $nombrePaciente;?>">
      <label id="validarNombre"></label>
    </div>
    <div class="form-group col-md-6 col-lg-6 col-sm-6">
      <label for="ape">¿Este es el apellido del paciente que desea eliminar?</label>
      <input  required type="text" id="apeShow" name="apeShow" placeholder="ingresa tu Apellido" class="form-control" value="<?php echo $apellidoPaciente;?>" disabled>
      <br> 
      <input name="ape" id="ape" type="hidden" value="<?php echo $apellidoPaciente;?>">
